...
const TechStack = memo(({ tech }) => (
  <div className="px-4 py-2 hidden sm:block rounded-full cursor-default bg-white/5 backdrop-blur-sm border border-white/10 text-sm text-gray-300 hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
...
const WORDS = ["Computer Science Student", "Tech Enthusiast | Problem-Solver"];
const TECH_STACK = ["Node.js", "Tailwind", "Typescript", "MongoDB", "Next.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/THUNDERBLD" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/faraz-mohammed-162289227" },
...
const Home = () => {
  ...
  // Fixed Lottie configuration - removed rendererSettings
  const lottieOptions = {
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            {/* Right Column - Fixed Lottie Animation */}
