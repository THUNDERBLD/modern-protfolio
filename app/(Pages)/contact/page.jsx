...
const page = () => {
  ...
  return (
    <>
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%] bg-black">
        <h2
          data-aos="fade-down"
      ...
      <div
        className="flex items-center justify-center py-10 px-4 sm:px-6 md:px-8 lg:px-26 bg-black"
        id="Contact"
      >
        <div 
          data-aos="fade-up"
          data-aos-duration="1200"
          className="w-full max-w-3xl bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 transform transition-all duration-300 hover:shadow-[#6366f1]/10"
        >
